...
void TableauDynamique::afficherDonnees() const
{
    cout << "Le tableau est de capacite " << capacite << " et contient " << taille_utilisee << " elements : ";
    afficher();
}

void TableauDynamique::ajuster()
{
    int nb = log10(capacite);
    capacite = pow(10, nb + 1);
}
